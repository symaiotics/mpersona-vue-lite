    ...
    <div class="flex flex-wrap -mx-3 mb-1">
        ...
        <template v-if="localPersona">
            <div class="w-full m-2">
                ...
                <div v-if="localPersona.url">
                    <img :src="localPersona.url" alt="Avatar Image" class="object-cover mb-4 rounded-md w-48 h-48">
                </div>

                <div v-else-if = "userAvatar">
                    <img :src="userAvatar" alt="Default avatar Image" class="object-cover  mb-4 rounded-md w-48 h-48">
                </div>
                ...
                <div v-else>
                 ...
                 <button v-if="localPersona.isAdmin || localPersona.isEditor || !localPersona.id"
            ...
            <div class="w-full px-3 pt-3" v-if="localPersona.id">
                <p> Contributors</p>
                <!-- {{ localPersona }} -->
                <table class="w-full">
                    <thead>
            ...
            <div v-if="!localPersona?.id" class="w-full px-3">
            ...
            <div v-if="localPersona?.knowledgeProfiles?.length && (localPersona.isAdmin)" class="w-full m-3 space-x-4">
            ...
            <div v-if="localPersona.id && (localPersona.isAdmin || localPersona.isOwner || localPersona.isEditor)"
...
const userAvatar = computed(
    () =>
        `https://api.dicebear.com/7.x/adventurer/svg?seed=${localPersona?.value?.name.replace(
            /[^a-z0-9]+/gi,
            '-'
        )}`
)
...
function triggerUpdate() {
    let tempPersona = JSON.parse(JSON.stringify(localPersona.value))
    if(userAvatar.value && !tempPersona.url) tempPersona.url = userAvatar.value
    updatePersonas([tempPersona]);
}
